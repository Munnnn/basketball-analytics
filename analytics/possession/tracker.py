...
class PossessionTracker:
    ...
    def update_possession(self,
        ...
        # FIXED: No ball detected - proper numpy array handling
        if (ball_track is None or
            ball_track.current_position is None or
            (isinstance(ball_track.current_position, np.ndarray) and ball_track.current_position.size == 0)):
    ...
    def _find_player_in_possession(self,
        ...
        for track in player_tracks:
            if (track.current_position is None or
                (isinstance(track.current_position, np.ndarray) and track.current_position.size == 0)):
                continue
